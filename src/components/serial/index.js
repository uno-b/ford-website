      ...
      <div className={styles.container}>
        ...
        <ul>
          ...
          <li>
            ...
            with this alternative method i.e. by pressing and holding down
            buttons 2 & 6.
          </li>
          <li>
            You can find that number on the label on the top of your unit.
          </li>
          <li>
            Or without removing unit just press and hold buttons 6 and 1 on
            radio until the V number displays
          </li>
        </ul>
